...
;842:}
;843:
;844:qboolean trap_G2API_GetBoltMatrix_NoRecNoRot(void *ghoul2, const int modelIndex, const int boltIndex, mdxaBone_t *matrix,
...
line 847
;847:	return (qboolean)(syscall(G_G2_GETBOLT_NOREC_NOROT, ghoul2, modelIndex, boltIndex, matrix, angles, position, frameNum, modelList, scale));
CNSTI4 588
ARGI4
ADDRFP4 0
INDIRP4
...
;848:}
;849:
;850:int trap_G2API_InitGhoul2Model(void **ghoul2Ptr, const char *fileName, int modelIndex, qhandle_t customSkin,
;851:						  qhandle_t customShader, int modelFlags, int lodBias)
;852:{
line 853
;853:	return syscall(G_G2_INITGHOUL2MODEL, ghoul2Ptr, fileName, modelIndex, customSkin, customShader, modelFlags, lodBias);
CNSTI4 589
ARGI4
ADDRFP4 0
INDIRP4
...
;854:}
;855:
;856:int trap_G2API_AddBolt(void *ghoul2, int modelIndex, const char *boneName)
;857:{
line 858
;858:	return syscall(G_G2_ADDBOLT, ghoul2, modelIndex, boneName);
CNSTI4 590
ARGI4
ADDRFP4 0
INDIRP4
...
;859:}
;860:
;861:void trap_G2API_SetBoltInfo(void *ghoul2, int modelIndex, int boltInfo)
;862:{
line 863
;863:	syscall(G_G2_SETBOLTINFO, ghoul2, modelIndex, boltInfo);
CNSTI4 591
ARGI4
ADDRFP4 0
INDIRP4
...
line 869
;865:
;866:qboolean trap_G2API_SetBoneAngles(void *ghoul2, int modelIndex, const char *boneName, const vec3_t angles, const int flags,
;867:								const int up, const int right, const int forward, qhandle_t *modelList,
;868:								int blendTime , int currentTime )
;869:{
line 870
;870:	return (syscall(G_G2_ANGLEOVERRIDE, ghoul2, modelIndex, boneName, angles, flags, up, right, forward, modelList, blendTime, currentTime));
CNSTI4 592
ARGI4
ADDRFP4 0
INDIRP4
...
;871:}
;872:
;873:qboolean trap_G2API_SetBoneAnim(void *ghoul2, const int modelIndex, const char *boneName, const int startFrame, const int endFrame,
;874:							  const int flags, const float animSpeed, const int currentTime, const float setFrame , const int blendTime )
;875:{
line 876
;876:	return syscall(G_G2_PLAYANIM, ghoul2, modelIndex, boneName, startFrame, endFrame, flags, PASSFLOAT(animSpeed), currentTime, PASSFLOAT(setFrame), blendTime);
ADDRFP4 24
INDIRF4
ARGF4
ADDRLP4 0
...
;877:}
;878:
;879:void trap_G2API_GetGLAName(void *ghoul2, int modelIndex, char *fillBuf)
;880:{
line 881
;881:	syscall(G_G2_GETGLANAME, ghoul2, modelIndex, fillBuf);
CNSTI4 594
ARGI4
ADDRFP4 0
INDIRP4
...
line 885
;883:
;884:int trap_G2API_CopyGhoul2Instance(void *g2From, void *g2To, int modelIndex)
;885:{
line 886
;886:	return syscall(G_G2_COPYGHOUL2INSTANCE, g2From, g2To, modelIndex);
CNSTI4 595
ARGI4
ADDRFP4 0
INDIRP4
...
;887:}
;888:
;889:void trap_G2API_CopySpecificGhoul2Model(void *g2From, int modelFrom, void *g2To, int modelTo)
;890:{
line 891
;891:	syscall(G_G2_COPYSPECIFICGHOUL2MODEL, g2From, modelFrom, g2To, modelTo);
CNSTI4 596
ARGI4
ADDRFP4 0
INDIRP4
...
line 895
;893:
;894:void trap_G2API_DuplicateGhoul2Instance(void *g2From, void **g2To)
;895:{
line 896
;896:	syscall(G_G2_DUPLICATEGHOUL2INSTANCE, g2From, g2To);
CNSTI4 597
ARGI4
ADDRFP4 0
INDIRP4
...
line 900
;898:
;899:qboolean trap_G2API_HasGhoul2ModelOnIndex(void *ghlInfo, int modelIndex)
;900:{
line 901
;901:	return syscall(G_G2_HASGHOUL2MODELONINDEX, ghlInfo, modelIndex);
CNSTI4 598
ARGI4
ADDRFP4 0
INDIRP4
...
;902:}
;903:
;904:qboolean trap_G2API_RemoveGhoul2Model(void *ghlInfo, int modelIndex)
;905:{
line 906
;906:	return syscall(G_G2_REMOVEGHOUL2MODEL, ghlInfo, modelIndex);
CNSTI4 599
ARGI4
ADDRFP4 0
INDIRP4
...
;907:}
;908:
;909:void trap_G2API_CleanGhoul2Models(void **ghoul2Ptr)
;910:{
line 911
;911:	syscall(G_G2_CLEANMODELS, ghoul2Ptr);
CNSTI4 600
ARGI4
ADDRFP4 0
INDIRP4
...
line 928
;913:
;914:void trap_G2API_CollisionDetect ( 
;915:	CollisionRecord_t *collRecMap, 
;916:	void* ghoul2, 
;917:	const vec3_t angles, 
;918:	const vec3_t position,
;919:	int frameNumber, 
;920:	int entNum, 
;921:	vec3_t rayStart, 
;922:	vec3_t rayEnd, 
...
;928:{
line 929
;929:	syscall ( G_G2_COLLISIONDETECT, collRecMap, ghoul2, angles, position, frameNumber, entNum, rayStart, rayEnd, scale, traceFlags, useLod, PASSFLOAT(fRadius) );
ADDRFP4 44
INDIRF4
ARGF4
ADDRLP4 0
