...
ASGNI4
line 2387
;2385:	int myps[MAX_POWERUPS],mypw[MAX_POWERUPS];
;2386:	// event-only entities will have been dealt with already
;2387:	if ( cent->currentState.eType >= ET_EVENTS ) {
ADDRFP4 0
INDIRP4
CNSTI4 4
ADDP4
...
;2389:	}
;2390:
;2391:	// calculate the current origin
;2392:	CG_CalcEntityLerpPositions( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
line 2395
;2393:
;2394:	// add automatic effects
;2395:	CG_EntityEffects( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
line 2401
;2396:/*
;2397:Ghoul2 Insert Start
;2398:*/
;2399:
;2400:	// do this before we copy the data to refEnts
;2401:	if (trap_G2_HaveWeGhoul2Models(cent->ghoul2))
ADDRFP4 0
INDIRP4
CNSTI4 952
ADDP4
...
;2402:	{
line 2403
;2403:		trap_G2_SetGhoul2ModelIndexes(cent->ghoul2, cgs.gameModels, cgs.skins);
ADDRFP4 0
INDIRP4
CNSTI4 952
ADDP4
...
;2405:
;2406:/*
;2407:Ghoul2 Insert End
;2408:*/
;2409:	switch ( cent->currentState.eType ) {
ADDRLP4 140
ADDRFP4 0
INDIRP4
CNSTI4 4
...
line 2411
;2410:	default:
;2411:		CG_Error( "Bad entity type: %i\n", cent->currentState.eType );
ADDRGP4 $1413
ARGP4
ADDRFP4 0
INDIRP4
...
JUMPV
line 2416
;2413:	case ET_INVISIBLE:
;2414:	case ET_PUSH_TRIGGER:
;2415:	case ET_TELEPORT_TRIGGER:
;2416:		break;
LABELV $1415
line 2418
;2417:	case ET_GENERAL:
;2418:		CG_General( cent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 CG_General
...
LABELV $1418
line 2427
;2426:	case ET_MISSILE:
;2427:		CG_Missile( cent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 CG_Missile
...
LABELV $1419
line 2430
;2429:	case ET_SPECIAL:
;2430:		CG_Special( cent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 CG_Special
...
LABELV $1420
line 2433
;2432:	case ET_HOLOCRON:
;2433:		CG_General( cent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 CG_General
...
LABELV $1424
line 2445
;2444:	case ET_SPEAKER:
;2445:		CG_Speaker( cent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 CG_Speaker
...
LABELV $1425
line 2448
;2447:	case ET_GRAPPLE: //An entity that wants to be able to use ghoul2 humanoid anims. Like a player, but not.
;2448:		CG_G2Animated( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
;2456:}
LABELV $1403
endproc CG_AddCEntity 148 12
export CG_ManualEntityRender
proc CG_ManualEntityRender 0 4
line 2459
;2457:
;2458:void CG_ManualEntityRender(centity_t *cent)
;2459:{
line 2460
;2460:	CG_AddCEntity(cent);
ADDRFP4 0
INDIRP4
ARGP4
...
;2463:/*
;2464:===============
;2465:CG_AddPacketEntities
;2466:
;2467:===============
;2468:*/
;2469:void CG_AddPacketEntities( void ) {
line 2475
;2470:	int					num;
;2471:	centity_t			*cent;
;2472:	playerState_t		*ps;
;2473:
;2474:	// set cg.frameInterpolation
;2475:	if ( cg.nextSnap ) {
ADDRGP4 cg+40
INDIRP4
CVPU4 4
...
;2476:		int		delta;
;2477:
;2478:		delta = (cg.nextSnap->serverTime - cg.snap->serverTime);
ADDRLP4 16
CNSTI4 8
ASGNI4
ADDRLP4 12
...
LABELV $1436
line 2482
;2482:			cg.frameInterpolation = (float)( cg.time - cg.snap->serverTime ) / delta;
ADDRGP4 cg+44
ADDRGP4 cg+64
INDIRI4
ADDRGP4 cg+36
...
LABELV $1431
line 2485
;2485:		cg.frameInterpolation = 0;	// actually, it should never be used, because 
ADDRGP4 cg+44
CNSTF4 0
ASGNF4
line 2487
;2486:									// no entities should be marked as interpolating
;2487:	}
LABELV $1432
line 2490
;2488:
;2489:	// the auto-rotating items will all have the same axis
;2490:	cg.autoAngles[0] = 0;
ADDRGP4 cg+3520
CNSTF4 0
ASGNF4
line 2491
;2491:	cg.autoAngles[1] = ( cg.time & 2047 ) * 360 / 2048.0;
ADDRGP4 cg+3520+4
CNSTI4 360
ADDRGP4 cg+64
INDIRI4
...
ASGNF4
line 2492
;2492:	cg.autoAngles[2] = 0;
ADDRGP4 cg+3520+8
CNSTF4 0
ASGNF4
line 2494
;2493:
;2494:	cg.autoAnglesFast[0] = 0;
ADDRGP4 cg+3568
CNSTF4 0
ASGNF4
line 2495
;2495:	cg.autoAnglesFast[1] = ( cg.time & 1023 ) * 360 / 1024.0f;
ADDRGP4 cg+3568+4
CNSTI4 360
ADDRGP4 cg+64
INDIRI4
...
ASGNF4
line 2496
;2496:	cg.autoAnglesFast[2] = 0;
ADDRGP4 cg+3568+8
CNSTF4 0
ASGNF4
line 2498
;2497:
;2498:	AnglesToAxis( cg.autoAngles, cg.autoAxis );
ADDRGP4 cg+3520
ARGP4
ADDRGP4 cg+3532
ARGP4
...
pop
line 2499
;2499:	AnglesToAxis( cg.autoAnglesFast, cg.autoAxisFast );
ADDRGP4 cg+3568
ARGP4
ADDRGP4 cg+3580
ARGP4
...
line 2502
;2500:
;2501:	// generate and add the entity from the playerstate
;2502:	ps = &cg.predictedPlayerState;
ADDRLP4 8
ADDRGP4 cg+96
ASGNP4
line 2508
;2503:
;2504:	//rww - update the g2 pointer BEFORE the weapons, otherwise bad things could happen
;2505:	//FIXME: These two pointers seem to differ sometimes, they shouldn't, should they?
;2506:	//the one on predictedPlayerEntity also seems to often be invalid, so it can't be
;2507:	//reliably checked and cleared.
;2508:	cg.predictedPlayerEntity.ghoul2 = cg_entities[ cg.snap->ps.clientNum].ghoul2;
ADDRGP4 cg+1476+952
CNSTI4 1920
ADDRGP4 cg+36
INDIRP4
...
ASGNP4
line 2509
;2509:	CG_CheckPlayerG2Weapons(ps, &cg.predictedPlayerEntity);
ADDRLP4 8
INDIRP4
ARGP4
ADDRGP4 cg+1476
...
pop
line 2510
;2510:	BG_PlayerStateToEntityState( ps, &cg.predictedPlayerEntity.currentState, qfalse );
ADDRLP4 8
INDIRP4
ARGP4
ADDRGP4 cg+1476
...
line 2513
;2511:	
;2512:	// add in the Ghoul2 stuff.
;2513:	VectorCopy( cg_entities[ cg.snap->ps.clientNum].modelScale, cg.predictedPlayerEntity.modelScale);
ADDRGP4 cg+1476+964
CNSTI4 1920
ADDRGP4 cg+36
INDIRP4
...
ASGNB 12
line 2514
;2514:	cg.predictedPlayerEntity.radius = cg_entities[ cg.snap->ps.clientNum].radius;
ADDRGP4 cg+1476+976
CNSTI4 1920
ADDRGP4 cg+36
INDIRP4
...
line 2516
;2515:
;2516:	CG_AddCEntity( &cg.predictedPlayerEntity );
ADDRGP4 cg+1476
ARGP4
ADDRGP4 CG_AddCEntity
CALLV
...
line 2519
;2517:
;2518:	// lerp the non-predicted value for lightning gun origins
;2519:	CG_CalcEntityLerpPositions( &cg_entities[ cg.snap->ps.clientNum ] );
CNSTI4 1920
ADDRGP4 cg+36
INDIRP4
CNSTI4 188
...
line 2522
;2520:
;2521:	// add each entity sent over by the server
;2522:	for ( num = 0 ; num < cg.snap->numEntities ; num++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRGP4 $1479
...
LABELV $1476
line 2524
;2523:		// Don't re-add ents that have been predicted.
;2524:		if (cg.snap->entities[ num ].number != cg.snap->ps.clientNum)
CNSTI4 296
ADDRLP4 0
INDIRI4
MULI4
...
;2525:		{
line 2526
;2526:			cent = &cg_entities[ cg.snap->entities[ num ].number ];
ADDRLP4 4
CNSTI4 1920
CNSTI4 296
ADDRLP4 0
...
line 2533
;2531:
;2532:void CG_ROFF_NotetrackCallback( centity_t *cent, const char *notetrack)
;2533:{
line 2534
;2534:	int i = 0, r = 0, objectID = 0, anglesGathered = 0, posoffsetGathered = 0;
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRLP4 516
...
line 2540
;2535:	char type[256];
;2536:	char argument[512];
;2537:	char addlArg[512];
;2538:	char errMsg[256];
;2539:	char t[64];
;2540:	int addlArgs = 0;
ADDRLP4 1388
CNSTI4 0
ASGNI4
line 2543
;2541:	vec3_t parsedAngles, parsedOffset, useAngles, useOrigin, forward, right, up;
;2542:
;2543:	if (!cent || !notetrack)
ADDRLP4 1708
CNSTU4 0
ASGNU4
ADDRFP4 0
...
;2546:	}
;2547:
;2548:	//notetrack = "effect effects/explosion1.efx 0+0+64 0-0-1";
;2549:
;2550:	while (notetrack[i] && notetrack[i] != ' ')
;2551:	{
line 2552
;2552:		type[i] = notetrack[i];
ADDRLP4 0
INDIRI4
ADDRLP4 600
ADDP4
...
EQI4 $1494
line 2559
;2559:	{ //didn't pass in a valid notetrack type, or forgot the argument for it
line 2560
;2560:		return;
ADDRGP4 $1486
JUMPV
...
line 2566
;2564:
;2565:	while (notetrack[i] && notetrack[i] != ' ')
;2566:	{
line 2567
;2567:		argument[r] = notetrack[i];
ADDRLP4 516
INDIRI4
ADDRLP4 856
ADDP4
...
LABELV $1504
line 2585
;2584:		while (notetrack[i])
;2585:		{
line 2586
;2586:			addlArg[r] = notetrack[i];
ADDRLP4 516
INDIRI4
ADDRLP4 4
ADDP4
...
;2596:		{
line 2599
;2597:			//sprintf(errMsg, "Offset position argument for 'effect' type is invalid.");
;2598:			//goto functionend;
;2599:			VectorClear(parsedOffset);
ADDRLP4 1724
CNSTF4 0
ASGNF4
ADDRLP4 588+8
...
ASGNF4
line 2600
;2600:			goto defaultoffsetposition;
ADDRGP4 $1514
JUMPV
LABELV $1510
line 2603
...
line 2606
;2604:
;2605:		while (posoffsetGathered < 3)
;2606:		{
line 2607
;2607:			r = 0;
ADDRLP4 516
...
LABELV $1518
line 2609
;2608:			while (addlArg[i] && addlArg[i] != '+' && addlArg[i] != ' ')
;2609:			{
line 2610
;2610:				t[r] = addlArg[i];
ADDRLP4 516
...
;2617:			{ //failure..
line 2620
;2618:				//sprintf(errMsg, "Offset position argument for 'effect' type is invalid.");
;2619:				//goto functionend;
;2620:				VectorClear(parsedOffset);
ADDRLP4 1728
CNSTF4 0
ASGNF4
ADDRLP4 588+8
...
ASGNI4
line 2622
;2622:				goto defaultoffsetposition;
ADDRGP4 $1514
JUMPV
LABELV $1523
line 2624
;2623:			}
;2624:			parsedOffset[posoffsetGathered] = atof(t);
ADDRLP4 520
ARGP4
ADDRLP4 1728
ADDRGP4 atof
...
;2629:		{
line 2630
;2630:			Com_sprintf(errMsg, sizeof(errMsg), "Offset position argument for 'effect' type is invalid.");
ADDRLP4 1392
ARGP4
CNSTI4 256
ARGI4
...
line 2643
;2640:
;2641:defaultoffsetposition:
;2642:
;2643:		objectID = trap_FX_RegisterEffect(argument);
ADDRLP4 856
ARGP4
ADDRLP4 1724
ADDRGP4 trap_FX_RegisterEffect
...
EQI4 $1535
line 2648
;2648:			{ //if there is an additional argument for an effect it is expected to be XANGLE-YANGLE-ZANGLE
line 2649
;2649:				i++;
ADDRLP4 0
ADDRLP4 0
...
LABELV $1540
line 2654
;2653:					while (addlArg[i] && addlArg[i] != '-')
;2654:					{
line 2655
;2655:						t[r] = addlArg[i];
ADDRLP4 516
...
NEI4 $1544
line 2663
;2663:					{ //failed to get a new part of the vector
line 2664
;2664:						anglesGathered = 0;
ADDRLP4 1368
CNSTI4 0
ASGNI4
line 2665
...
;2666:					}
;2667:
;2668:					parsedAngles[anglesGathered] = atof(t);
ADDRLP4 520
ARGP4
ADDRLP4 1732
ADDRGP4 atof
...
;2673:				{
line 2674
;2674:					VectorCopy(parsedAngles, useAngles);
ADDRLP4 1696
ADDRLP4 1648
INDIRB
ASGNB 12
...
line 2677
;2676:				else
;2677:				{ //failed to parse angles from the extra argument provided..
line 2678
;2678:					VectorCopy(cent->lerpAngles, useAngles);
ADDRLP4 1696
ADDRFP4 0
INDIRP4
CNSTI4 940
...
line 2682
;2681:			else
;2682:			{ //if no constant angles, play in direction entity is facing
line 2683
;2683:				VectorCopy(cent->lerpAngles, useAngles);
ADDRLP4 1696
ADDRFP4 0
INDIRP4
CNSTI4 940
...
line 2686
;2685:
;2686:			AngleVectors(useAngles, forward, right, up);
ADDRLP4 1696
ARGP4
ADDRLP4 1660
ARGP4
...
line 2688
;2687:
;2688:			VectorCopy(cent->lerpOrigin, useOrigin);
ADDRLP4 1376
ADDRFP4 0
INDIRP4
CNSTI4 928
...
;2689:
;2690:			//forward
;2691:			useOrigin[0] += forward[0]*parsedOffset[0];
ADDRLP4 1376
ADDRLP4 1376
INDIRF4
ADDRLP4 1660
...
ASGNF4
line 2692
;2692:			useOrigin[1] += forward[1]*parsedOffset[0];
ADDRLP4 1376+4
ADDRLP4 1376+4
INDIRF4
ADDRLP4 1660+4
...
ASGNF4
line 2693
;2693:			useOrigin[2] += forward[2]*parsedOffset[0];
ADDRLP4 1376+8
ADDRLP4 1376+8
INDIRF4
ADDRLP4 1660+8
...
;2694:
;2695:			//right
;2696:			useOrigin[0] += right[0]*parsedOffset[1];
ADDRLP4 1376
ADDRLP4 1376
INDIRF4
ADDRLP4 1672
...
ASGNF4
line 2697
;2697:			useOrigin[1] += right[1]*parsedOffset[1];
ADDRLP4 1376+4
ADDRLP4 1376+4
INDIRF4
ADDRLP4 1672+4
...
ASGNF4
line 2698
;2698:			useOrigin[2] += right[2]*parsedOffset[1];
ADDRLP4 1376+8
ADDRLP4 1376+8
INDIRF4
ADDRLP4 1672+8
...
;2699:
;2700:			//up
;2701:			useOrigin[0] += up[0]*parsedOffset[2];
ADDRLP4 1376
ADDRLP4 1376
INDIRF4
ADDRLP4 1684
...
ASGNF4
line 2702
;2702:			useOrigin[1] += up[1]*parsedOffset[2];
ADDRLP4 1376+4
ADDRLP4 1376+4
INDIRF4
ADDRLP4 1684+4
...
ASGNF4
line 2703
;2703:			useOrigin[2] += up[2]*parsedOffset[2];
ADDRLP4 1376+8
ADDRLP4 1376+8
INDIRF4
ADDRLP4 1684+8
...
line 2705
;2704:
;2705:			trap_FX_PlayEffectID(objectID, useOrigin, useAngles);
ADDRLP4 1372
INDIRI4
ARGI4
ADDRLP4 1376
...
LABELV $1507
line 2708
;2708:	else if (strcmp(type, "sound") == 0)
ADDRLP4 600
ARGP4
ADDRGP4 $1568
ARGP4
...
;2709:	{
line 2710
;2710:		objectID = trap_S_RegisterSound(argument);
ADDRLP4 856
ARGP4
ADDRLP4 1728
...
ASGNI4
line 2711
;2711:		trap_S_StartSound(cent->lerpOrigin, cent->currentState.number, CHAN_BODY, objectID);
ADDRLP4 1732
ADDRFP4 0
INDIRP4
ASGNP4
...
LABELV $1566
line 2713
;2713:	else if (strcmp(type, "loop") == 0)
ADDRLP4 600
ARGP4
ADDRGP4 $1571
ARGP4
...
;2721:		{
line 2722
;2722:			Com_Printf("^3Warning: \"%s\" is an invalid ROFF notetrack function\n", type);
ADDRGP4 $1574
ARGP4
ADDRLP4 600
ARGP4
...
;2725:		{
line 2726
;2726:			Com_Printf("^3Warning: Notetrack is missing function and/or arguments\n");
ADDRGP4 $1575
ARGP4
ADDRGP4 Com_Printf
CALLV
...
;2731:
;2732:functionend:
;2733:	Com_Printf("^3Type-specific notetrack error: %s\n", errMsg);
ADDRGP4 $1576
ARGP4
ADDRLP4 1392
ARGP4
